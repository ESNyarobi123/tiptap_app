...
class StorageService {
  ...
  Future<void> setRememberMe(bool value) => _storage.write(key: _rememberKey, value: value.toString());

  Future<String?> getSavedEmail() => _storage.read(key: _emailKey);
  Future<void> setSavedEmail(String? email) =>
      email != null ? _storage.write(key: _emailKey, value: email) : _storage.delete(key: _emailKey);
